...
t_data.Quantize(x_test, minval=-2.5, maxval=2.5, row=len(x_test), col=1)
...
temp_Q.Quantize(W, row=1, col=hx1.shape[1]) 
"""
#quantize input
...
for name, weight in net.named_parameters():
    ...
    if "fc1" in name:
        ...
        temp_Q.BinaryQuantize(W, row=W.shape[0], col=W.shape[1]) 
