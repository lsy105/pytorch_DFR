...
# NARMA30 dataset
import scipy.io
#x = scipy.io.loadmat('Kian_data/receivedSignal-202by2.mat')['receivedSignal']
#y1 = scipy.io.loadmat('Kian_data/label23.mat')['label']
#y2 = scipy.io.loadmat('Kian_data/label24.mat')['label']
#y3 = scipy.io.loadmat('Kian_data/label25.mat')['label']
